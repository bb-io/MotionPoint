...
public class TargetLanguageDataHandler(InvocationContext invocationContext, [ActionParameter] LanguageRequest languageRequest) 
    : LanguageBaseDataHandler(invocationContext, languageRequest)
{
    protected override LanguageRole Language => LanguageRole.Target;
}